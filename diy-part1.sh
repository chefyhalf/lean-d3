...
# git clone -b 18.06 https://github.com/rosywrt/luci-theme-rosy.git package/lean/luci-theme-rosy
...
# sed -i '1i src-git kenzok8 https://github.com/kenzok8/small-package' feeds.conf.default
sed -i '1i src-git NueXini https://github.com/NueXini/NueXini_Packages' feeds.conf.default
